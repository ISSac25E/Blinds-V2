// Compatable Only with BlindsV2_1.0.4

//////////////////////////////////////////////////////////

// Setup Servo Control:
#define ESP_SIGNAL_PIN 12 // Set Pin which Arduino will Conect to ESP
#define SERVO_PIN 3       // Set Pin to Servo
...
#define SERVO_POS_DELAY_ms 1000  // Servo Open Close Delay in ms(milliseconds)
